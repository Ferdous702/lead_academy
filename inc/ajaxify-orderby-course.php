                ...
                '<div class="course-card-box course-'.$product_id.' current-'.$cur_page.' course-cat-'.$product_cat_id->term_id.'" style="'.$hide_the_product.'">
                    <div class="course-card">
                        <div class="course-card-img">
                            <img src="'.esc_url( $course_image ).'" alt="'.esc_attr(get_the_title($product_id)).'" title="'.esc_attr(get_the_title($product_id)).'"/>
                        </div>
                        <div class="course-body">
                            ...
                            <div class="la-rv-course-ratings">
                                <img src="'.get_site_url().'/wp-content/uploads/2022/08/Group-15155.png" alt="tp-logo" title="tp-logo">
                            </div>
                            <div>
                    ...
                    <div class="course-d-btn">
                        <a href="'.esc_url(get_the_permalink($product_id)).'" class="course-title">View Course <img src="'.get_site_url().'/wp-content/uploads/2022/10/view-course-right-arrow.svg" alt="view-course-right-arrow" title="view-course-right-arrow"></a>
                    </div>
                </div>
                ';
        }
