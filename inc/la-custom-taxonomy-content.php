...
function add_course_type( $types ) {
    $types[] = ( is_shop() || is_product_category() || is_product() ) ? 'courses' : '';
    return $types;
}
...
function la_coupon_thankyou( $order_id ) {
	echo 'Thank you. Your order has been received. You will get your course login details from our learning portal within 24 hours. For any Query email us to: <a href="mailto:info@lead-academy.org">info@lead-academy.org</a><br>You will receive your order confirmation email in 10 minute, please check your email inbox or junk for that.';
	//echo ' <br/>If you only want to book your Functional Skills remote exam then please provide your preferred exam date and time 2 days prior for NCFE or 9 days prior for Edexcel to the exam date with a copy of your passport or driving license and send in info@lead-academy.org, then our relevant team will book the exam accordingly.';
}