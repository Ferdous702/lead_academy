            ...
            <div class="course-card-box">
                <div class="course-card">
                    <div class="course-card-img">
                        <img src="<?php echo $course_image?>" alt="<?php echo get_the_title()?>" title="<?php echo get_the_title()?>">
                    </div>
                    <div class="course-body">
                        ...
                        <div class="la-rv-course-ratings">
                            <img src="<?php echo get_site_url()?>/wp-content/uploads/2022/12/Trustpilot.svg" alt="reviews-image" title="reviews-image">
                        </div>
                        <div>
                ...
                <div class="course-d-btn">
                    <a href="<?php echo get_the_permalink()?>" class="course-title">
                        View Course 
                        <img src="<?php echo get_site_url()?>/wp-content/uploads/2022/10/view-course-right-arrow.svg" alt="right arrow icon" title="right arrow icon">
                    </a>                                            
                </div>
            </div>
        </div>
