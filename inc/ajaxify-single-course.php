            ...
            '<div class="course-card-box">
                <div class="course-card">
                    <div class="course-card-img">
                        <img src="'.$course_image.'" alt="'.$product_image_alt.'" title="'.$product_image_alt.'"/>
                    </div>
                    <div class="course-body">
                        ...
                        <div class="la-rv-course-ratings">
                            <img src="'.get_site_url().'/wp-content/uploads/2022/10/reviews-io-195x19-1.png" alt="tp-logo" title="tp-logo">
                        </div>
                        <div>
                ...
                <div class="course-d-btn">
                    <a href="'.esc_url(get_the_permalink()).'" class="course-title">View Course <img src="'.get_site_url().'/wp-content/uploads/2022/10/view-course-right-arrow.svg" alt="right arrow" title="right arrow"></a>
                </div>
            </div>
            ';
    endwhile;
