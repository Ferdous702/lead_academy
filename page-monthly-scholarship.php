...
get_header();
?>
<div class="hero-section-scholarship" style="text-align:center; padding: 3rem 1rem;">
	<h1>Monthly Scholarship at Lead Academy</h1>
</div>
<!--Banner Section-->
<img src="https://lead-academy.org/wp-content/uploads/2022/10/scholarship-email-banner-.jpg" alt="" style="
    width: 100%;
">
<!--Review Section-->
        ...
        <div class="row">
            ...
            <?php
                $bundle_courses_items = [
                    ...
                    [
                        'bundle_course_img'           => '/wp-content/uploads/2023/05/beauty-spa-min.webp',
                        'bundle_course_title'         => 'Massage Therapy',
                        'bundle_course_sec_title'     => '8 Premium Courses Bundle',
                        'bundle_course_description'   => 'This massage therapy diploma course will give you a competitive advantage in your career, making you stand…..',
                    ...
                    [
                        'bundle_course_img'           => 'https://lead-academy.org/wp-content/uploads/2023/05/tender-african-woman-smiling-enjoying-massage-with-closed-eyes-spa-resort-min-1.webp',
                        'bundle_course_title'         => 'International Massage',
                        'bundle_course_sec_title'     => '8 Premium Courses Bundle',
                        'bundle_course_description'   => 'The Massage Therapy course will set you up with the appropriate skills and experience needed for the job and…..',
                        'bundle_course_rating'        => '4.9',
                        'bundle_course_regular_price' => '£792.00',
                        'bundle_course_sale_price'    => '£69.00',
                        'bundle_course_btn_text'      => 'Learn More',
                    ...
                    [
                        ...
                        'bundle_course_sale_price'    => '£39.00',
                        'bundle_course_btn_text'      => 'Learn More',
                    ...
                    [
                        ...
                        'bundle_course_rating'        => '4.9',
                        'bundle_course_regular_price' => '£396.00',
                        'bundle_course_sale_price'    => '£35.00',
                        'bundle_course_btn_text'      => 'Learn More',
                    ...
                    [
                        ...
                        'bundle_course_rating'        => '4.9',
                        'bundle_course_regular_price' => '£395.00',
                        'bundle_course_sale_price'    => '£39.00',
                        'bundle_course_btn_text'      => 'Learn More',
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                <div class="bundle-courses-card-box">
                    ...
                    <div class="bundle-course-box-dtls">
                        ...
                        <div class="bundle-course-discount-percent"><img src="https://lead-academy.org/wp-content/uploads/0223/12/94off.webp" alt="99off"></div>
                        ...
                        <p class="bundle-p"><?php echo $course['bundle_course_sec_title']; ?></p>
