...
$fs_course_info = [
    ...
    [
        ...
        'desc' => 'This course is assessed with 3 exams. You can sit your Functional Skills English Level 2 exams remotely or at one of our test centres.'
    ],
    [
        'title' => 'What you can do next',
        'sub' => 'Look at the further opportunities available.',
        'desc' => 'Functional Skills English Level 2 is an essential qualification to apply for jobs, higher education courses, apprenticeships and training courses where a GCSE English pass grade (9-4 / A*-C) or equivalent is an entry requirement.'
    ]
];
$fs_partner_info = [
    [
        ...
        'title' => 'Edexcel',
        'text' => 'Edexcel Functional Skills Maths Level 1 Past Papers',
        'url' => '/edexcel-functional-skills-maths-level-1-past-papers'
    ],
    [
        'img' => '/wp-content/uploads/2022/10/City-and-Guilds-Logo-150x150-1.jpg',
        'title' => 'City and Guilds',
        'text' => 'City and Guilds Functional Skills Maths Level 1 Past Papers',
        'url' => '/city-and-guilds-functional-skills-maths-level-1-past-papers'
    ],
    [
        'img' => '/wp-content/uploads/2022/10/NCFE-Logo-150x150-1-e1707117410552.jpg',
        'title' => 'NCFE',
        'text' => 'NCFE Functional Skills Maths Level 1 Past Papers',
        'url' => '/ncfe-functional-skills-maths-level-1-past-papers'
    ],
    [
        'img' => '/wp-content/uploads/2022/10/AQA-Logo-150x150-1.jpg',
        'title' => 'AQA',
        'text' => 'AQA Functional Skills Maths Level 1 Past Papers',
        'url' => '/aqa-functional-skills-maths-level-1-past-papers'
    ],
    [
        'img' => '/wp-content/uploads/2022/10/Open-Awards-Logo-150x150-1.jpg',
        'title' => 'Open Awards',
        'text' => 'Open Awards Functional Skills Maths Level 1 Past Papers',
        'url' => '/open-awards-functional-skills-maths-level-1-past-papers'
    ]
];
?>
<section class="hero-text">
    <h1 class="text-center">Functional Skills Maths Level 1 Past Papers</h1>
        ...
        <!-- <div id="exam-course" class="qualification-details">
            ...
            <div class="details-content">
                <div class="content-wrap">
                    ...
                    <div class="text">Functional Skills Qualification in Maths</div>
                </div>
                <div class="content-wrap">
                ...
                <div class="fsc-custom-card-wrap exams" style="display: none">
                    ...
                    ?>
                        <div class="fsc-custom-card la-fs-xm-box english-2-fs-exam">
                            <img src="<?php echo esc_url($item['img_url']) ?>" alt="<?php echo esc_html($item['course_title']) ?>" width="327" height="196">
                            <div class="fsc-card-contents">
                                <p class="fsc-card-title"><a href="<?php echo esc_url($item['course_url']) ?>"><?php echo esc_html($item['course_title']) ?></a></p>
                                <p class="fsc-card-price-content">
                                    <span><?php echo esc_html($item['first_line']) ?></span>
                                    <span><?php echo esc_html($item['second_line']) ?></span>
                                </p>
                        ...
                        <div class="col-md-6">
                            <div class="mock-area">
                                ...
                                <div class="mock-content">
                                    <p><a href="<?= $mock['url'] ?>"><?= $mock['title'] ?></a></p>
