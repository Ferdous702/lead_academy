<style>
    ...
    .postid-440908 .cntc-single-card-contents {
        ...
        <div class="phlebotomy-top-3">
            <div class="phlebotomy-container">
                <div class="single-phlebotomy-top-3">
                    <div class="float-row">
                        <div class="float-left">         
                            <img src="/wp-content/uploads/0223/12/Get-Accredited.webp" alt="Get Accredited Logo">
                        </div>
                ...
                <div class="single-phlebotomy-top-3">
                    <div class="float-row">
                        <div class="float-left">         
                            <img src="/wp-content/uploads/0223/12/Get-Insured.webp" alt="Get Insured Logo">
                        </div>
                        <div class="float-right nail-technician-top-4-right">         
                            <p>Get Insured</p>
                        </div>
                ...
                <div class="single-phlebotomy-top-3">
                    <div class="float-row">
                        <div class="float-left">         
                            <img src="/wp-content/uploads/0223/12/Get-Recognised.webp" alt="Get Recognised Logo">
                        </div>
                        <div class="float-right nail-technician-top-4-right">         
                            <p>Get Recognised</p>
                        </div>
                ...
                <div class="single-phlebotomy-top-3">
                    <div class="float-row">
                        <div class="float-left">         
                            <img src="/wp-content/uploads/0223/12/Earn-Money.webp" alt="Earn Money Logo">
                        </div>
                        <div class="float-right nail-technician-top-4-right">         
                            <p>Earn Money</p>
                        </div>
                ...
                <div class="d-flex justify-content-between">
                    <div class="hero-left">
                        ...
                        <ul class="list-unstyled nail-course-includes">
                            ...
                            ?>
                            <li>
                                <span><img src="/wp-content/uploads/2022/10/recognised-certificate.png" alt="Recognition Icon"></span>
                                <span><b>Certificate:</b> CPD UK Accredited PDF Certificate Included</span>
                            </li>
                            <li>
                                <span><img src="/wp-content/uploads/0223/12/Recognition.webp" alt="Recognition Icon"></span>
                                <span><b>Recognition:</b> Accredited by CPD UK & IPHM</span>
                            </li>
                            <li>
                                <span><img src="/wp-content/uploads/0223/12/Duration.webp" alt="Duration Icon"></span>
                                <span><b>Duration:</b> 3 Days Practical Training</span>
                            </li>
                            <li>
                                <span><img src="/wp-content/uploads/0223/12/Timing.webp" alt="Timing Icon"></span>
                                <span><b>Time:</b> 10 am to 5:30 pm</span>
                            </li>
                            <li>
                                <span><img src="/wp-content/uploads/0223/12/Guidance.webp" alt="Guidance Icon"></span>
                                <span><b>Guidance:</b> Continuous Expert Guidance</span>
                            </li>
                            <li>
                                <span><img src="/wp-content/uploads/0223/12/Entry-Requirement.webp" alt="Entry Requirement Icon"></span>
                                <span><b>Entry Requirement:</b> No academic qualification and no experience are required</span>
                            </li>
                            <li>
                                <span><img src="/wp-content/uploads/0223/12/Live-Practice.webp" alt="Live Practice Icon"></span>
                                <span><b>Live Practice:</b> Practice on each other/ Artificial Arm</span>
                            </li>
                            <li>
                                <span><img src="/wp-content/uploads/0223/12/Payment.webp" alt="Payment Icon"></span>
                                <span><b>Payment:</b> Interest-Free Installments</span>
                            </li>
                            <li>
                                <span><img src="/wp-content/uploads/0223/12/Nail-Kits.webp" alt="Nail Kits Icon"></span>
                    ...
                    <div class="hero-right">
                        <div class="hero-big-img">
                            <img src="/wp-content/uploads/0223/12/Eyelash-Extension-Training-Course-Birmingham1.webp" alt="woman-with-nail-art-promoting-design-luxury-earrings-ring">
                        </div>
                        <div class="hero-small-imgs">
                            <img src="/wp-content/uploads/0223/12/Eyelash-Extension-Training-Course-Birmingham2.webp" alt="black-nails-manicure 2">
                            <img src="/wp-content/uploads/0223/12/Eyelash-Extension-Training-Course-Birmingham3.webp" alt="black-nails-manicure 2">
                            <img src="/wp-content/uploads/0223/12/Eyelash-Extension-Training-Course-Birmingham4.webp" alt="black-nails-manicure 2">
                            <img src="/wp-content/uploads/0223/12/Eyelash-Extension-Training-Course-Birmingham5.webp" alt="black-nails-manicure 2">
                        </div>
                    </div>      <!-- end hero-right -->
                </div>          <!-- end d-flex -->
            </div>          <!-- end row -->
                ...
                <div class="service-details-wrap d-flex justify-content-center">
                    ...
                    <div class="right-service-item">
                        <div class="right-service-item-single">
                            <img src="/wp-content/uploads/0223/12/Eyelash-Extension-Training-Course-Birmingham6.webp" alt="beautiful-woman-s-nails-with-beautiful-creative-manicure">
                        </div>
                        <div class="right-service-item-single">
            ...
            <div class="row">   
                <div class="cntc-two-cards d-flex justify-content-center">
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/Eyelash-Extension-Training-Course-Birmingham7.webp" alt="manicures-day1">
                    ...
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/Eyelash-Extension-Training-Course-Birmingham8.webp" alt="pedicure-day1">
                        <div class="cntc-single-card-contents">
            ...
            <div class="msg-train-b">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 align-self-center">
                        ...
                        <ul>
                            <li>Get Accredited Certificate in Just 1 day </li>
                            <li>OOver 5000 Certificates Awarded </li>
...
@media screen and (max-width: 767px) {
    ...
    .unique-popup-p {
        font-size: 22px !important; /* Reduce header font size */
    }
