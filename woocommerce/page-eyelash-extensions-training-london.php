                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="hero-right">
                        <div class="hero-big-img">
                            <img src="/wp-content/uploads/0223/12/Eyelash_Extensions1.webp" alt="woman-with-nail-art-promoting-design-luxury-earrings-ring">
                        </div>
                        <div class="hero-small-imgs">
                            <img src="/wp-content/uploads/0223/12/Eyelash_Extensions2.webp" alt="black-nails-manicure 2">
            ...
            <div class="row">   
                <div class="cntc-two-cards d-flex justify-content-center">
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/Eyelash_Extensions7.webp" alt="manicures-day1">
    ...
    <div id="la-single-feedbacks" class="mb-5 ssd-none d-xl-block w-100">
        ...
        <?php
            if ( count( $course_reviews ) > 1 ) {
                la_manual_review($course_reviews);
                // Come from inc/la-reviews.php 
            } else {
                la_get_reviews_part();
            }
        ?>
...
<div id="unique-flash-sale-popup" class="unique-popup-container">
    <div class="unique-popup-content">
        ...
        <p>Grab 20% Off for the next 24 hours only</p>
        <?php
