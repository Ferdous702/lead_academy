                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="hero-right">
                        <div class="hero-big-img">
                            <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon1.webp" alt="woman-with-nail-art-promoting-design-luxury-earrings-ring">
                        </div>
                        <div class="hero-small-imgs">
                            <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon2.webp" alt="black-nails-manicure 2">
                            <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon3.webp" alt="black-nails-manicure 2">
                            <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon4.webp" alt="black-nails-manicure 2">
                            <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon5.webp" alt="black-nails-manicure 2">
                        </div>
                    </div>      <!-- end hero-right -->
                </div>          <!-- end d-flex -->
            </div>          <!-- end row -->
                ...
                <div class="service-details-wrap d-flex justify-content-center">
                    <div class="left-service-item">
                        <div class="left-service-item-single">
                            <?php if (!empty($la_nail_technician_course_description_title)): ?>
                        ...
                        <div class="left-service-item-single">
                            <?php if (!empty($la_nail_technician_course_highlights_title)): ?>
                    ...
                    <div class="right-service-item">
                        <div class="right-service-item-single">
                            <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon6.webp" alt="beautiful-woman-s-nails-with-beautiful-creative-manicure">
                        </div>
                        <div class="right-service-item-single">
                            <?php if (!empty($la_nail_technician_who_is_title)): ?>
    ...
    <section id="cntc-daywise-course">
            ...
            <div class="row">   
                <div class="cntc-two-cards d-flex justify-content-center">
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon7.webp" alt="manicures-day1">
                    ...
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon8.webp" alt="pedicure-day1">
                        <div class="cntc-single-card-contents">
        ...
        <div class="container">
            <div class="row">   
                <div class="cntc-two-cards d-flex justify-content-center">
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon9.webp" alt="gel-extensions-day2">
                        <div class="cntc-single-card-contents">
                    ...
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon10.webp" alt="gel-polish-day2">
                        <div class="cntc-single-card-contents">
        ...
        <div class="container">
            <div class="row">   
                <div class="cntc-two-cards d-flex justify-content-center">
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon11.webp" alt="acrylics-day3-img">
                        <div class="cntc-single-card-contents">
                    ...
                    <div class="cntc-single-card">
                        <img src="/wp-content/uploads/0223/12/complete-nail-technician-course-swindon12.webp" alt="Sculpting-with-Acrylic">
                        <div class="cntc-single-card-contents">
            ...
            <div class="msg-train-b">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        ...
                        <?php if (!empty($la_nail_technician_why_train_title)): ?>
