...
input#gform_submit_button_133 {
    background-color: #af1f47 !important;
    padding: 12px 40px !important;
    border: 2px solid #af1f47 !important;
}

input#gform_submit_button_133:hover {
    background-color:rgb(255, 255, 255) !important;
    padding: 12px 40px !important;
    color: #af1f47 ;
    border: 2px solid #af1f47 !important;
...
<script>
    jQuery(document).ready(function() {
        jQuery('#input_133_4').val('<?=$product_name?>');
        jQuery('#input_133_5').val('<?=$location?>');
        jQuery('#input_133_6_3').val('<?=$billing_name?>');
        ...
        jQuery('#input_133_9').val(formattedDate);
    });
</script>
<?php
?>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <h1>Advanced Competency Practical Consent Form</h1>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <?php echo do_shortcode('[gravityform id="133" title="false"]'); ?>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <?php echo do_shortcode('[contact-form-7 id="35dd562" title="Consent Form Advanced Phlebotomy"]'); ?>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
    </div>
</div>
