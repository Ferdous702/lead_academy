    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7">
                <h1>Vaccination SkillsTraining</h1>
                <p>Accepted by Employers and CPD Certified training equips you with the necessary clinical skills to ensure you meet the highest standards in healthcare.</p>
                <style>
            .google-review-svg {
                width: 400px;
            }
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 phuk-about-text-col">
                <div class="phuk-about-text">
                    <h2>Our Vaccination SkillsTraining Sessions</h2>
                    <p>Vaccination is one of the most commonly performed invasive procedure in the healthcare sector. For this procedure to be performed safely and effectively, staff must possess the necessary up-to-date knowledge and skills.</p>
                    <p>3 hours online and 8 hours practical training is accepted by healthcare employers and approved by CPD, ensuring that participants receive a high-quality education and are equipped with the necessary skills to excel in their Vaccination careers. Participants will learn essential techniques, such as venepuncture and specimen collection, through interactive sessions and practical exercises, allowing them to gain confidence and proficiency in their abilities.</p>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <div class="phuk-about-video">
                    <img src="https://lead-academy.org/wp-content/uploads/2023/05/plebotomy-practical-session-27-may.webp" alt="Our Vaccination SkillsTraining Sessions">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
                <h2>Our Locations</h2>
                <p>Vaccination SkillsTraining</p>
            </div>
        </div>
                    ...
                    <div class="card pt-course-card">
                        <div class="row">
                            <div class="card-content col-md-6">
                                <p><a href="/course/vaccination-and-immunisation-training">Vaccination SkillsTraining</a></p>
                                <p class="mb-4"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><style>svg{fill:#c52855}</style><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg> London</p>
                                <ul>
                                ...
                                <a class="round-button" href="/course/vaccination-and-immunisation-training">View Course</a>
                            </div>
                            <div class="col-md-6">
                                <img src="/wp-content/uploads/2024/01/Untitled-2.webp" alt="Vaccination SkillsTraining London">
                            </div>
                        </div>
                    </div>
                    <div class="card pt-course-card">
                        <div class="row">
                            <div class="card-content col-md-6">
                                <h2><a href="/course/vaccination-and-immunisation-training-birmingham">Vaccination SkillsTraining</a></h2>
                                <p class="mb-4"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><style>svg{fill:#c52855}</style><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg> Birmingham</p>
                                <ul>
                                    <li>1 Day Face to Face Training</li>
                                    <li>4 Instalments at Checkout</li>
                                    <li>Accredited by CPD UK</li>
                                ...
                                <a class="round-button" href="/course/vaccination-and-immunisation-training-birmingham">View Course</a>
                            </div>
                            <div class="col-md-6">
                                <img src="/wp-content/uploads/2024/01/Untitled-3.webp" alt="Vaccination SkillsTraining Birmingham">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 offset-md-3 offset-lg-3 offset-xl-3">
                <div class="phuk-card-box">
                    <img src="/wp-content/uploads/2024/10/phlebotomy.cardiff.webp" alt="Phlebotomy Training Cardiff">
                    <div class="phuk-btm-box">
                        <h3><a href="/course/phlebotomy-training-cardiff">Phlebotomy Training</a></h3>
                        <h4><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><style>svg{fill:#c52855}</style><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg> Cardiff</h4>
                        <ul>
                            <li>1 Day Face to Face Training</li>
                            <li>4 Instalments at Checkout</li>
                            <li>Accredited by CPD UK</li>
                        ...
                        <div class="phuk-course-btn">
                            <a href="/course/phlebotomy-training-cardiff">BOOK NOW</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section id="phuk-venue-sec" class="advanced-phlebotomy-training">
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
                <h2>Our Venues</h2>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <div class="phuk-card-box">
                    <img src="/wp-content/uploads/2024/01/Advanced-Competency-Phlebotomy-Training-Swindon.webp" alt="Advanced / Competency Phlebotomy Training Swindon">
                    <div class="phuk-btm-box">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <div class="phuk-card-box">
                    <img src="/wp-content/uploads/2024/10/Advanced-Competency-Phlebotomy-Training-Bristol-–-Part-2.webp" alt="Advanced / Competency Phlebotomy Training Bristol">
                    <div class="phuk-btm-box">
                        <h3><a href="/course/advanced-competency-phlebotomy-training-bristol">Advanced / Competency Phlebotomy Training Bristol</a></h3>
                        <!-- <h4><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><style>svg{fill:#c52855}</style><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"></path></svg> Birmingham</h4> -->
                        <ul>
                            <li>3 Days Face to Face Training</li>
                            <li>Gain Competency Skills and Certificate</li>
                        ...
                        <div class="phuk-course-btn">
                            <a href="/course/advanced-competency-phlebotomy-training-bristol">BOOK NOW</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <div class="phuk-card-box">
                    <img src="/wp-content/uploads/2025/01/Advanced-Competency-Phlebotomy-Training-Cardiff-Part-2.webp" alt="Advanced / Competency Phlebotomy Training Cardiff">
                    <div class="phuk-btm-box">
                        <h3><a href="/course/advanced-competency-phlebotomy-training-cardiff">Advanced / Competency Phlebotomy Training Cardiff</a></h3>
                        <!-- <h4><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><style>svg{fill:#c52855}</style><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"></path></svg> Birmingham</h4> -->
                        <ul>
                            <li>3 Days Face to Face Training</li>
                            <li>Gain Competency Skills and Certificate</li>
                        ...
                        <div class="phuk-course-btn">
                            <a href="/course/advanced-competency-phlebotomy-training-cardiff">BOOK NOW</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 phuk-advance-col">
                <div class="phuk-advance-text">
                    ...
                    <p>Upon finishing the Advanced Competency Phlebotomy Training Part 2, you will receive a <strong>certificate of competence</strong> along with a <strong>job recommendation letter</strong> signed by your trainer. This certificate is widely accepted by healthcare employers and will add significant <strong>value to your job application</strong> when you apply for <strong>phlebotomist</strong> positions.</p>
                </div>
