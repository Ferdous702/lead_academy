...
input#gform_submit_button_134 {
    background-color: #af1f47 !important;
    padding: 12px 40px !important;
    border: 2px solid #af1f47 !important;
}

input#gform_submit_button_134:hover {
    background-color:rgb(255, 255, 255) !important;
    padding: 12px 40px !important;
    color: #af1f47 ;
    border: 2px solid #af1f47 !important;
...
<script>
    jQuery(document).ready(function() {
        jQuery('#input_134_4').val('<?=$product_name?>');
        jQuery('#input_134_5').val('<?=$location?>');
        jQuery('#input_134_6_3').val('<?=$billing_name?>');
        ...
        jQuery('#input_134_9').val(formattedDate);
    });
</script>
<?php
?>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <h1>Cannulation Training Consent Form</h1>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <?php echo do_shortcode('[gravityform id="134" title="false"]'); ?>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <?php echo do_shortcode('[contact-form-7 id="601bfeb" title="Consent Form IV Cannulation Training"]'); ?>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
    </div>
</div>
