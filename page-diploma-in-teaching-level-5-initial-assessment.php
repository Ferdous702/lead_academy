...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <h1>Diploma in Teaching Level 5 - Initial Assessment</h1>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10">
            <?php echo do_shortcode('[contact-form-7 id="497a4a5" title="TQUK Diploma in Teaching Level 5 - Initial Assessment"]'); ?>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1"></div>
    </div>
</div>
