    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-7 col-xl-7">
                <h1>Vitamin B12 Injection Course</h1>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 phuk-about-text-col">
                <div class="phuk-about-text">
                    <h2>Our Vitamin B12 Injection Course Sessions</h2>
                    <p>Phlebotomy is one of the most commonly performed invasive procedure in the healthcare sector. For this procedure to be performed safely and effectively, staff must possess the necessary up-to-date knowledge and skills.</p>
                    <p><strong>3 hours online and 8 hours practical training is accepted by healthcare employers and approved by CPD,</strong> ensuring that participants receive a high-quality education and are equipped with the necessary skills to excel in their phlebotomy careers. Participants will learn essential techniques, such as venepuncture and specimen collection, through interactive sessions and practical exercises, allowing them to gain confidence and proficiency in their abilities.</p>
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <div class="phuk-about-video">
                    <img src="https://lead-academy.org/wp-content/uploads/2023/05/plebotomy-practical-session-27-may.webp" alt="Vitamin B12 Injection Course">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center">
                <h2>Our Venues</h2>
                <p>Vitamin B12 Injection Course</p>
            </div>
        </div>
                    ...
                    <div class="card pt-course-card">
                        <div class="row">
                            <div class="card-content col-md-6">
                                <h2><a href="/course/vitamin-b12-injection-course">Vitamin B12 Injection Course</a></h2>
                                ...
                                <a class="round-button" href="/course/vitamin-b12-injection-course">View Course</a>
                            </div>
                            <div class="col-md-6">
                                <img src="/wp-content/uploads/2024/02/Vitamin-B12-injections-3.webp" alt="Vitamin B12 Injection Course London">
                            </div>
                        </div>
                    </div>
                    <div class="card pt-course-card">
                        <div class="row">
                            <div class="card-content col-md-6">
                                <h2><a href="/course/vitamin-b12-injection-course-birmingham">Vitamin B12 Injection Course</a></h2>
                                ...
                                <a class="round-button" href="/course/vitamin-b12-injection-course-birmingham">View Course</a>
                            </div>
                            <div class="col-md-6">
                                <img src="/wp-content/uploads/0223/12/Vitamin-B12-injections-1.webp" alt="Vitamin B12 Injection Course Birmingham">
                            </div>
                        </div>
                    </div>
                </div>
...
<section id="phuk-venue-sec" class="advanced-phlebotomy-training">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                <div class="phuk-card-box">
                    <img src="/wp-content/uploads/0223/12/bristol-1-scaled.webp" alt="Advanced / Competency Phlebotomy Training Bristol">
                    <div class="phuk-btm-box">
