                    ...
                    <div class="card pt-course-card">
                        <div class="row">
                            <div class="card-content col-md-6">
                                <h2><a href="/course/ecg-training">ECG Training</a></h2>
                                ...
                                <a class="round-button" href="/course/ecg-training">View Course</a>
                            </div>
                            <div class="col-md-6">
                                <img src="/wp-content/uploads/0223/12/ECG-2.webp" alt="ECG Training London">
                            </div>
                        </div>
                    </div>
                    <div class="card pt-course-card">
                        <div class="row">
                            <div class="card-content col-md-6">
                                <h2><a href="/course/ecg-training-birmingham">ECG Training</a></h2>
                                ...
                                <a class="round-button" href="/course/ecg-training-birmingham">View Course</a>
                            </div>
                            <div class="col-md-6">
                                <img src="/wp-content/uploads/0223/12/ECG-4.webp" alt="ECG Training Birmingham">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 phuk-advance-col">
                <div class="phuk-advance-text">
                    ...
                    <p>Upon finishing the Advanced Competency Phlebotomy Training Part 2, you will receive a <strong>certificate of competence</strong> along with a <strong>job recommendation letter</strong> signed by your trainer. This certificate is widely accepted by healthcare employer and will add significant <strong>value to your job application</strong> when you apply for <strong>phlebotomist</strong> positions.</p>
                </div>
