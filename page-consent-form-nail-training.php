...
if (is_user_logged_in()) {
    ...
    $title = "Nail Training Consent Form";
    ...
    if (array_intersect($allowed_roles, (array) $current_user->roles) || 
        (in_array('subscriber', (array) $current_user->roles) && in_array($current_user->ID, $listed_subscribers))) {
            if(isset($_POST['email'])){
                ...
                $subject = 'Urgent: Nail Training Consent Form - Must Sign';
                $headers = ['Content-Type: text/html; charset=UTF-8'];
                $message = '
                <p>Dear Learner,</p>
                <p>Good day! Hope this email finds you well. You are required to sign the phlebotomy training consent form. It is mandatory to sign the consent soon.</p>
                <p>Please <a href="https://lead-academy.org/nail-training-consent-form/">click here</a> and sign the consent digitally.</p>
