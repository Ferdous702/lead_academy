...
<style>
    ...
    background: url(/wp-content/uploads/2024/11/PAT-Testing-Training-1-Day-CPD-Accredited-1.webp);
    padding: 70px 0px;
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <h1>PAT Testing Training Declaration</h1>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8">
                <?php echo do_shortcode('[contact-form-7 id="bbccac9" title="PAT Testing Training Declaration"]'); ?>
            </div>
            <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2"></div>
        </div>
    </div>
