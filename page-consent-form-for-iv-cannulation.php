...
if (is_user_logged_in()) {
    ...
    $title = "Cannulation Training Consent Form";
    ...
    if (array_intersect($allowed_roles, (array) $current_user->roles) || 
        (in_array('subscriber', (array) $current_user->roles) && in_array($current_user->ID, $listed_subscribers))) {
            if(isset($_POST['email'])){
                ...
                $subject = 'Urgent: Cannulation Training Consent Form - Must Sign';
                $headers = ['Content-Type: text/html; charset=UTF-8'];
                $message = '
                <p>Dear Learner,</p>
                <p>Good day! Hope this email finds you well. You are required to sign the cannulation training consent form. It is mandatory to sign the consent soon.</p>
                <p>Please <a href="https://lead-academy.org/consent-form-iv-cannulation/">click here</a> and sign the consent digitally.</p>
