jQuery(document).ready(function () {
    ...
    // For Cart Page suggetion offer add
    jQuery('body').on('click', '#add-suggestion-course-to-cart', function () {
    ...
    */
    ...
    jQuery('body').on('click', '.la-office-2021-purchase-wrap a.purchase-office-2021', function (event) {
        ...
        let product_id = jQuery(this).parent().data('course-id');
...
//let blackFridayDay = new Date("2024-04-05T00:00:00Z").getTime();
var currentYear = new Date().getFullYear();
var currentMonth = new Date().getMonth();
var currentDate = new Date().getDate();
var lastDayOfThisMonth = new Date(currentYear, currentMonth + 1, 0);
var distance = 3; // distance of days
var myDate = Math.ceil(currentDate / distance) * distance;
if(myDate >= lastDayOfThisMonth.getDate()){
// If myDate greater or equal to lastDayOfThisMonth
var blackFridayDay = new Date(currentYear, currentMonth + 1, distance).getTime();
}else{
var blackFridayDay = new Date(currentYear, currentMonth, myDate+1).getTime();
}
...
if ($shortform == 'yes') {
blackFridayCountdownHolder[i].innerHTML = '<i class="fa fa-snowflake-o"></i> Only today left at this price!';
} else {
blackFridayCountdownHolder[i].innerHTML = '<i class="fa fa-snowflake-o"></i> ' + days + ' days ' + hours + ' hours ' + minutes + ' minutes left at this price!';
}
}
...
blackFridayCountdownHolder[j].style.display = '';
blackFridayCountdownHolder[j].innerHTML = "";
}
}
}, 1000);
}