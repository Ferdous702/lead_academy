...
section#assignment-hero-section {
    background: linear-gradient(0deg, #af1f47a8, #af1f47ba), url(https://lead-academy.org/wp-content/uploads/2023/02/About-us-bg.webp);
...
button#gform_browse_button_107_14 {
...
.page-id-419653 button#gform_browse_button_107_58 {
    background-color: #b91948;
    border-radius: 40px;
}

.page-id-419653  button.gform_delete_file.gform-theme-button.gform-theme-button--simple {
    color: #af1f47;
}

.page-id-419653 .gform_wrapper.gravity-theme .gform_drop_area {
    padding: 25px;
}
...
<section id="assignment-hero-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1>Assignment - CACHE Award in RQF Level 3 Health and Social Care</h1>
            </div>
        </div>
    </div>
</section>
...
<section id="assignment-form">
    <div class="container">
        <div class="row">
            ...
            </div><?php echo do_shortcode( '[gravityform id="107" title="false" description="false" ajax="true"]' ); ?>
        </div>
    </div>
</section>
