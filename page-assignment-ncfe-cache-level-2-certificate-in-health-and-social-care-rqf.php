...
button#gform_browse_button_114_14 {
    background-color: #AF1F47;
    border-radius: 40px;
}

input#gform_submit_button_114 {
    background-color: #AF1F47;
}
...
button#gform_browse_button_114_58 {
...
<section id="assignment-hero-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1>Assignment - CACHE Level 2 Certificate in RQF Health and Social Care</h1>
            </div>
        </div>
    </div>
</section>
...
<section id="assignment-form">
    <div class="container">
        <div class="row">
            ...
            </div><?php echo do_shortcode('[contact-form-7 id="12709e5" title="Assignment - NCFE CACHE Level 2 Certificate in Health and Social Care - RQF"]'); ?>
        </div>
    </div>
</section>
