...
" class="google-review-svg" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" viewBox="0 0 317 25">
    ...
    <div class="fsc-promotion">
        <div class="fsc-floating-items">
            <div class="fsc-item">
                <p class="fsc-floating-lf-1">100% Money Back</p>
                <p>14 days Money Back Guarantee</p>
            </div>
            <div class="fsc-item">
                <p class="fsc-floating-m-1">Equivalent to GCSE</p>
                <p>NATIONALLY RECOGNISED QUALIFICATIONS</p>
            </div>
            <div class="fsc-item">
                <p class="fsc-floating-lf-1">Start From £149</p>
    ...
    <div class="fsc-container">
        <div class="fsc-left-content">
            ...
            <ul>
                ...
                <li>The Pearson Edexcel & NCFE Functional Skills courses are suitable for people of all ages.</li>
        ...
        <div class="fsc-custom-card-wrap courses">
            ...
            $fsc_courses_card_items = [
                ...
                [
                    ...
                    'course_url'   => '/course/digital-functional-skills-entry-level-3',
                ...
                [
                    ...
                    'course_url'   => '/course/digital-functional-skills-level-1',
            ...
            foreach( $fsc_courses_card_items as $item ) {
                ...
                <div class="fsc-custom-card">
                    ...
                    <div class="fsc-card-contents">
                        ...
                        <ul>
                            <li>Live 1:1 Tutor Support via Microsoft Teams</li>
                            ...
                            <!--<li><?php //echo esc_html($item['retake'])?></li>-->
                        </ul>
