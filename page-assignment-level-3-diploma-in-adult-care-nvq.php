...
<section id="assignment-hero-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1>Assignment - Level 3 Diploma in Adult Care – NVQ</h1>
            </div>
        </div>
    </div>
</section>
...
<section id="assignment-form">
    <div class="container">
        <div class="row">
            ...
            </div><?php echo do_shortcode( '[contact-form-7 id="e5a48e9" title="Assignment - Level 3 Diploma in Adult Care – NVQ"]' ); ?>
        </div>
    </div>
</section>
