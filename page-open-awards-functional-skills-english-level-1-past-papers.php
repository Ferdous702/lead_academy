...
<section class="hero-text">
    <h1 class="text-center">Open Awards Functional Skills English Level 1 Past Papers</h1>
...
<h2>Open Awards Functional Skills English Level 1 Past Papers: At a Glance</h2>
...
<div class="promo-btn-box">
    <div class="row">
        ...
        <div class="col-md-3">
            <a href="https://lead-academy.org/open-awards-functional-skills-english-level-1-past-papers#">Learn More</a>
        </div>
    </div>
</div>

<h2>Full List of Open Awards Functional Skills English Level 1 Past Papers</h2>
<div class="pdf-links-area">
    <table>
        <thead>
            <tr>
                <th>Open Awards Functional Skills English Level 1</th>
                <th></th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>Functional Skills English Level 1 Speaking, Listening and Communicating</td>
                <td><a href="https://lms.lead-academy.org/wp-content/uploads/2022/05/Functional-Skills-English-Level-1-Speaking-Listening-and-Communicating-Resource.pdf?_gl=1*h6p0kl*_gcl_au*MTU0Mjc3NTk5LjE3MTc1NjUyMjk.*_ga*MTM5OTgzNDI3NS4xNzE3NTY1MjMw*_ga_JXKLM9RV5Y*MTcxOTQwNjUyNC45Ny4xLjE3MTk0MDg1MzQuNTcuMC4w">View Resource</a></td>
            </tr>
